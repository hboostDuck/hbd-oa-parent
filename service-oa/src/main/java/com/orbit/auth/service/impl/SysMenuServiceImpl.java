...
import com.orbit.auth.mapper.SysMenuMapper;
import com.orbit.auth.mapper.SysRoleMenuMapper;
...
import com.orbit.vo.system.AssginMenuVo;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public boolean removeById(Serializable id) {
        ...
        if (count > 0) {
            throw new BizException(201,"菜单不能删除");
        }
